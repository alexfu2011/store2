    ...
    return (
        <div>
            <Form style={styles} noValidate validated={validated} onSubmit={handleSubmit}>
                ...
                <Form.Row>
                    <Form.Group as={Col}>
                        <Form.Label>产品简述</Form.Label>
                        <Form.Control required type="text" value={formf.shortDescription} onChange={(e) => setField('shortDescription', e.target.value)} placeholder="请输入产品简述" />
                        <Form.Control.Feedback type="invalid">
                            请输入产品简述
                        </Form.Control.Feedback>
                    </Form.Group>
                ...
                <Form.Row>
                    <Form.Group as={Col}>
                        ...
                        <Form.Control required as="select" defaultValue='' value={formf.subCategory} onChange={(e) => setField('category', e.target.value)} >
                ...
                {storeError && <p style={{ color: 'red' }}>Cannot {isEdit ? '更新' : '添加'} the data </p>}
